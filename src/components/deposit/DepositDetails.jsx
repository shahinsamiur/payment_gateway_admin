import { useGetSingleDepositTransactionQuery } from "@/redux/features/financials";
...
const DepositDetails = ({ id, open, onClose, title }) => {
  const { data, isLoading } = useGetSingleDepositTransactionQuery(id, {
    skip: !id,
  });
