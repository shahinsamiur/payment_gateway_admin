...
export default function MobileBanking({ data, isLoading }) {
...
function List({ item }) {
  ...
  const [deletePaymentGateway] = useDeleteMobileBankingPaymentGatewayMutation();
  const [updatedGateWayStatus] = useUpdateMobileBankingPaymentGatewayMutation();
  ...
  return (
    <>
      <TableRow key={item.id}>
        <TableCell>{item.mobile_banking_name}</TableCell>
