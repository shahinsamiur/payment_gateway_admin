  ...
  return (
    <div>
      <Card sx={{ maxWidth: 800, mx: "auto", mt: 2 }}>
        <CardHeader title="Add Balance to User balance" />
        <Divider />
        <CardContent component="form" onSubmit={handleSubmit(onSubmit)}>
          <Stack spacing={2}>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    <MenuItem value="credit_earning_balance_by_system">
                      Add to Earning Balance
                    </MenuItem>
                    <MenuItem value="credit_deposit_balance_by_system">
            ...
            <div>
              <Typography>Select payment gateway</Typography>
              <Controller
